...
#define LMAT_CRAIGIEBURN_CGB_MID                        LMAT_BASE(0, 0, 1)
#define LMAT_CRAIGIEBURN_RXP                            LMAT_BASE(0, 0, 2)
#define LMAT_CRAIGIEBURN_RXP_MID                        LMAT_BASE(0, 0, 3)
#define LMAT_CRAIGIEBURN_CLO                            LMAT_BASE(0, 0, 4)
#define LMAT_CRAIGIEBURN_CLO_MID                        LMAT_BASE(0, 0, 5)
#define LMAT_CRAIGIEBURN_BMS                            LMAT_BASE(0, 1, 0)
#define LMAT_CRAIGIEBURN_BMS_MID                        LMAT_BASE(0, 1, 1)
#define LMAT_CRAIGIEBURN_JAC                            LMAT_BASE(0, 1, 2)
#define LMAT_CRAIGIEBURN_JAC_MID                        LMAT_BASE(0, 1, 3)
#define LMAT_CRAIGIEBURN_GRY                            LMAT_BASE(0, 1, 4)
#define LMAT_CRAIGIEBURN_GRY_MID                        LMAT_BASE(0, 1, 5)
#define LMAT_CRAIGIEBURN_OPK                            LMAT_BASE(0, 2, 0)
#define LMAT_CRAIGIEBURN_OPK_MID                        LMAT_BASE(0, 2, 1)
#define LMAT_CRAIGIEBURN_PVL                            LMAT_BASE(0, 2, 2)
#define LMAT_CRAIGIEBURN_PVL_MID                        LMAT_BASE(0, 2, 3)
#define LMAT_CRAIGIEBURN_SME                            LMAT_BASE(0, 2, 4)
#define LMAT_CRAIGIEBURN_SME_MID                        LMAT_BASE(0, 2, 5)
#define LMAT_CRAIGIEBURN_GBV                            LMAT_BASE(0, 3, 0)
#define LMAT_CRAIGIEBURN_GBV_MID                        LMAT_BASE(0, 3, 1)
#define LMAT_CRAIGIEBURN_ESD                            LMAT_BASE(0, 3, 2)
#define LMAT_CRAIGIEBURN_ESD_MID                        LMAT_BASE(0, 3, 3)
#define LMAT_CRAIGIEBURN_MPD                            LMAT_BASE(0, 3, 4)
#define LMAT_CRAIGIEBURN_MPD_MID                        LMAT_BASE(0, 3, 5)
#define LMAT_CRAIGIEBURN_ASV                            LMAT_BASE(0, 4, 0)
#define LMAT_CRAIGIEBURN_ASV_MID                        LMAT_BASE(0, 4, 1)

/* Flemington Racecourse line */
#define LMAT_FLEMINGTON_RCE                             LMAT_BASE(0, 4, 2)
#define LMAT_FLEMINGTON_RCE_MID                         LMAT_BASE(0, 4, 3)
#define LMAT_FLEMINGTON_SGS                             LMAT_BASE(0, 4, 4)
#define LMAT_FLEMINGTON_SGS_MID                         LMAT_BASE(0, 4, 5)

/* Craigieburn (continued - shared with Flemington Racecourse line) */
#define LMAT_CRAIGIEBURN_NKT                            LMAT_BASE(0, 5, 0)
#define LMAT_CRAIGIEBURN_NKT_MID                        LMAT_BASE(0, 5, 1)
#define LMAT_CRAIGIEBURN_KEN                            LMAT_BASE(0, 5, 2)
#define LMAT_CRAIGIEBURN_KEN_MID                        LMAT_BASE(0, 5, 3)

/* North Melbourne station */
#define LMAT_NORTHERN_NME                               LMAT_BASE(0, 5, 4)
#define LMAT_NORTHERN_NME_MID                           LMAT_BASE(0, 5, 5) // towards SSS

/* Sunbury line */
#define LMAT_SUNBURY_SBY                                LMAT_BASE(0, 6, 0)
#define LMAT_SUNBURY_SBY_MID                            LMAT_BASE(0, 6, 1)
#define LMAT_SUNBURY_DIT                                LMAT_BASE(0, 6, 2)
#define LMAT_SUNBURY_DIT_MID                            LMAT_BASE(0, 6, 3)
#define LMAT_SUNBURY_SDM                                LMAT_BASE(0, 6, 4)
#define LMAT_SUNBURY_SDM_MID                            LMAT_BASE(0, 6, 5)
#define LMAT_SUNBURY_KPL                                LMAT_BASE(0, 7, 0)
#define LMAT_SUNBURY_KPL_MID                            LMAT_BASE(0, 7, 1)
#define LMAT_SUNBURY_SAB                                LMAT_BASE(0, 7, 2)
#define LMAT_SUNBURY_SAB_MID                            LMAT_BASE(0, 7, 3)
#define LMAT_SUNBURY_GIN                                LMAT_BASE(0, 7, 4)
#define LMAT_SUNBURY_GIN_MID                            LMAT_BASE(0, 7, 5)
#define LMAT_SUNBURY_ALB                                LMAT_BASE(0, 8, 0)
#define LMAT_SUNBURY_ALB_MID                            LMAT_BASE(0, 8, 1)
#define LMAT_SUNBURY_SUN                                LMAT_BASE(0, 8, 2)
#define LMAT_SUNBURY_SUN_MID                            LMAT_BASE(0, 8, 3)
#define LMAT_SUNBURY_TOT                                LMAT_BASE(0, 8, 4)
#define LMAT_SUNBURY_TOT_MID                            LMAT_BASE(0, 8, 5)
#define LMAT_SUNBURY_WFY                                LMAT_BASE(0, 9, 0)
#define LMAT_SUNBURY_WFY_MID                            LMAT_BASE(0, 9, 1)
#define LMAT_SUNBURY_MFY                                LMAT_BASE(0, 9, 2)
#define LMAT_SUNBURY_MFY_MID                            LMAT_BASE(0, 9, 3)
#define LMAT_SUNBURY_FSY                                LMAT_BASE(0, 9, 4)
#define LMAT_SUNBURY_FSY_MID                            LMAT_BASE(0, 9, 5) // towards NME
...
#define LMAT_NORTHERN                                   \
    LMAT_CRAIGIEBURN_CGB, LMAT_CRAIGIEBURN_CGB_MID,    \
    LMAT_CRAIGIEBURN_RXP, LMAT_CRAIGIEBURN_RXP_MID,    \
    LMAT_CRAIGIEBURN_CLO, LMAT_CRAIGIEBURN_CLO_MID,    \
    LMAT_CRAIGIEBURN_BMS, LMAT_CRAIGIEBURN_BMS_MID,    \
    LMAT_CRAIGIEBURN_JAC, LMAT_CRAIGIEBURN_JAC_MID,    \
    LMAT_CRAIGIEBURN_GRY, LMAT_CRAIGIEBURN_GRY_MID,    \
    LMAT_CRAIGIEBURN_OPK, LMAT_CRAIGIEBURN_OPK_MID,    \
    LMAT_CRAIGIEBURN_PVL, LMAT_CRAIGIEBURN_PVL_MID,    \
    LMAT_CRAIGIEBURN_SME, LMAT_CRAIGIEBURN_SME_MID,    \
    LMAT_CRAIGIEBURN_GBV, LMAT_CRAIGIEBURN_GBV_MID,    \
    LMAT_CRAIGIEBURN_ESD, LMAT_CRAIGIEBURN_ESD_MID,    \
    LMAT_CRAIGIEBURN_MPD, LMAT_CRAIGIEBURN_MPD_MID,    \
    LMAT_CRAIGIEBURN_ASV, LMAT_CRAIGIEBURN_ASV_MID,    \
    LMAT_CRAIGIEBURN_NKT, LMAT_CRAIGIEBURN_NKT_MID,    \
    LMAT_CRAIGIEBURN_KEN, LMAT_CRAIGIEBURN_KEN_MID,    \
    LMAT_NORTHERN_NME, LMAT_NORTHERN_NME_MID,          \
    LMAT_SUNBURY_SBY, LMAT_SUNBURY_SBY_MID,            \
    LMAT_SUNBURY_DIT, LMAT_SUNBURY_DIT_MID,            \
    LMAT_SUNBURY_SDM, LMAT_SUNBURY_SDM_MID,            \
    LMAT_SUNBURY_KPL, LMAT_SUNBURY_KPL_MID,            \
    LMAT_SUNBURY_SAB, LMAT_SUNBURY_SAB_MID,            \
    LMAT_SUNBURY_GIN, LMAT_SUNBURY_GIN_MID,            \
    LMAT_SUNBURY_ALB, LMAT_SUNBURY_ALB_MID,            \
    LMAT_SUNBURY_SUN, LMAT_SUNBURY_SUN_MID,            \
    LMAT_SUNBURY_TOT, LMAT_SUNBURY_TOT_MID,            \
    LMAT_SUNBURY_WFY, LMAT_SUNBURY_WFY_MID,            \
    LMAT_SUNBURY_MFY, LMAT_SUNBURY_MFY_MID,            \
    LMAT_SUNBURY_FSY, LMAT_SUNBURY_FSY_MID,            \
...
#define LMAT_FLEMINGTON                                 \
    LMAT_FLEMINGTON_RCE, LMAT_FLEMINGTON_RCE_MID,      \
    LMAT_FLEMINGTON_SGS, LMAT_FLEMINGTON_SGS_MID

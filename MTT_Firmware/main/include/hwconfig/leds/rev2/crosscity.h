...
#define LMAT_FRANKSTON_ARM                              LMAT_BASE(2, 10, 5)
#define LMAT_FRANKSTON_ARM_ALT                          LMAT_BASE(2, 8, 5)
#define LMAT_FRANKSTON_TOR                              LMAT_BASE(2, 6, 5)
#define LMAT_FRANKSTON_TOR_ALT                          LMAT_BASE(2, 4, 5)
#define LMAT_FRANKSTON_HKN                              LMAT_BASE(2, 2, 5)
#define LMAT_FRANKSTON_HKN_ALT                          LMAT_BASE(2, 0, 5)

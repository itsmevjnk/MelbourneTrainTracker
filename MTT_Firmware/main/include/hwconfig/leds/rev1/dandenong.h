...
#define LMAT_PAKENHAM_HLM                               LMAT_BASE(5, 10, 0)
#define LMAT_PAKENHAM_HLM_ALT                           LMAT_BASE(5, 10, 1)
...
#define LMAT_DANDENONG_LAST_BEFORE_MT                   LMAT_DANDENONG_CFD
#define INFRAID_DANDENONG_LAST_BEFORE_MT                INFRAID_CFD
